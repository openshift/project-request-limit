...
require (
	...
	github.com/openshift/client-go v0.0.0-f0cf23f57c1f9c4831a9d416ca1cce1cf57b8552
	github.com/openshift/generic-admission-server v1.14.1-0.20220124211128-653129c3bbb6
	k8s.io/api v0.23.3
...
replace (
	github.com/openshift/api => github.com/josefkarasek/api-1 v0.0.0-20220209161218-70db28bc583f
	github.com/openshift/client-go => github.com/josefkarasek/client-go v0.0.0-20220209161354-183ed6b9c03b
